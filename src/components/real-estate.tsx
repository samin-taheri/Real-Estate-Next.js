...
const RealEstatePage: React.FC = () => {
  ...
  const initialPosts = [
    { id: 1, title: t("1-posts-title"), description: t("1-posts-desc"), image: "/1-2.jpg", location: "Kargicak", priceRange: t('1-posts-price'), saleOrRent: t('for-sale') },
    { id: 2, title: t("2-posts-title"), description: t("2-posts-desc"), image: "/2-6.jpg", location: "Alanya", priceRange: t('2-posts-price'), saleOrRent: t('for-sale') },
    { id: 3, title: t("3-posts-title"), description: t("3-posts-desc"), image: "/3-2.jpg", location: "Alanya", priceRange: t('3-posts-price'), saleOrRent: t('for-sale') },
    { id: 4, title: t("4-posts-title"), description: t("4-posts-desc"), image: "/4-2.jpg", location: "Oba", priceRange: t('4-posts-price'), saleOrRent: t('for-sale') },
    { id: 5, title: t("5-posts-title"), description: t("5-posts-desc"), image: "/5-1.jpg", location: "Demirtaş", priceRange: t('5-posts-price'), saleOrRent: t('for-sale') },
    { id: 6, title: t("6-posts-title"), description: t("6-posts-desc"), image: "/6-1.jpg", location: "Kargicak", priceRange: t('6-posts-price'), saleOrRent: t('for-sale') },
  ];
  ...
  return (
    <section id="property" className="px-10 py-10 mx-auto container p-10 flex-wrap">
      ...
      <a href="/view-more">
      <Button
        className="px-4 py-3 bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg flex flex-row"
