...
const RealEstatePage: React.FC = () => {
  ...
  const posts = [
    ...
    { id: 4, title: t('1-posts-title'), description: t('1-posts-desc'), image: "/1-1.jpg", location: "Kargicak", priceRange: t("1-posts-price"), saleOrRent: "For Sale"  },
    { id: 5, title: t('1-posts-title'), description: t('1-posts-desc'), image: "/1-1.jpg", location: "Kargicak", priceRange: t("1-posts-price"), saleOrRent: "For Sale"  },
    { id: 6, title: t('1-posts-title'), description: t('1-posts-desc'), image: "/1-1.jpg", location: "Kargicak", priceRange: t("1-posts-price"), saleOrRent: "For Sale"  },
  ];
  return (
    <section id="property">
