        ...
        <div className="container p-6 flex-wrap">
          <div className="grid lg:grid-cols-4 sm:grid-cols-2 gap-4 pb-5">
            <BenefitCard
              ...
              description={t("benefit-subtitle-1")}
            />
            <BenefitCard
              icon={
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
              ...
              description={t("benefit-subtitle-2")}
            />
            <BenefitCard
              icon={
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
              ...
              description={t("benefit-subtitle-3")}
            />
            <BenefitCard
              icon={
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
              ...
              description={t("benefit-subtitle-4")}
            />
            <BenefitCard
              icon={
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
              ...
              description={t("benefit-subtitle-5")}
            />
            <BenefitCard
              icon={
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
              ...
              description={t("benefit-subtitle-6")}
            />
            <BenefitCard
              icon={
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
              ...
              title={t("benefit-title-7")}
              description={t("benefit-subtitle-7")}
            />
            <BenefitCard
              icon={
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
              ...
              title={t("benefit-title-8")}
              description={t("benefit-subtitle-8")}
            />
          </div>
        </div>
      </div>
