...
const Subscribe = () => {
  ...
  return(
    <section className="text-gray-600 body-font" id="subscribe">
    <InfoSection>
    <div className="lg:w-1/2 px-6 lg:mt-0">
      <img className="w-18 h-18" alt="hero" src="/bg-24.jpg"/>
      </div>
      <div className="lg:w-1/2 px-6 py-3">
        <h2 className="m-5 title-font text-4xl font-semibold text-gray-700">{t("subscribe-title")}</h2> 
        <p className="m-5">{t("subscribe-subtitle")}</p>
