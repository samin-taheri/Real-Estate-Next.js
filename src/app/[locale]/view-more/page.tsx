...
const ViewMore: React.FC = () => {
  ...
  const posts = [
    { id: 1, title: t('1-posts-title'), description: t('1-posts-desc'), image: "/1-1.jpg", location: "Kargicak", priceRange: "850000", saleOrRent: "For Sale" },
    { id: 2, title: t('2-posts-title'), description: t('2-posts-desc'), image: "/2-1.jpg", location: "Alanya", priceRange: "110000", saleOrRent: "For Sale"  },
    ...
    { id: 4, title: t('4-posts-title'), description: t('4-posts-desc'), image: "/4-9.jpg", location: "Oba", priceRange: "249750", saleOrRent: "For Sale"  },
