...
const PostDetailPage: React.FC = () => {
  ...
  const posts = [
    ...
    { id: 2, title: t('2-posts-title'), description: t('2-posts-desc'), description2: t('2-posts-desc-2'), image: "/2-1.jpg", location: "Kargicak", locationDesc: t('2-posts-loc-desc'), priceRange: t("2-posts-price"), features: t("2-posts-features") ,features1: t("2-posts-features-1"),features2: t("2-posts-features-2"),features3: t("1-posts-features-3"), postCitizenship: t("2-posts-citizenship"), startDate: "01.01.2023" , endDate: "30.12.2024", additionalImages:  ["/2-1.jpg", "/2-3.jpg", "/2-4.jpg", "/2-5.jpg","/2-6.jpg", "/2-7.jpg", "/2-8.jpg", "/2-9.jpg","/2-10.jpg", "/2-11.jpg", "/2-12.jpg", "/2-13.jpg","/2-14.jpg", "/2-15.jpg", "/2-16.jpg", "/2-18.jpg"] },
    { id: 3, title: t('3-posts-title'), description: t('3-posts-desc'), description2: t('3-posts-desc-2'), image: "/3-1.jpg", location: "Alanya", locationDesc: t('3-posts-loc-desc'), priceRange: t("3-posts-price"), features: t("3-posts-features") ,features1: t("3-posts-features-1"),features2: t("3-posts-features-2"),features3: t("3-posts-features-3"), postCitizenship: t("3-posts-citizenship"), startDate: "01.10.2022" , endDate: "30.06. 2024", additionalImages:  ["/3-1.jpg", "/3-2.jpg", "/3-3.jpg", "/3-4.jpg", "/3-5.jpg", "/3-6.jpg", "/3-7.jpg", "/3-8.jpg","/3-9.jpg", "/3-10.jpg", "/3-11.jpg", "/3-13.jpg", "/3-14.jpg", "/3-15.jpg", "/3-16.jpg", "/3-16.jpg", "/3-17.jpg", "/3-18.jpg", "/3-19.jpg", "/3-20.jpg","/3-21.jpg", "/3-22.jpg", "/3-23.jpg", "/3-24.jpg", "/3-25.jpg"] },
    { id: 4, title: t('4-posts-title'), description: t('4-posts-desc'), description2: t('4-posts-desc-2'), image: "/4-1.jpg", location: "Oba", locationDesc: t('4-posts-loc-desc'), priceRange: t("3-posts-price"), features: t("4-posts-features") ,features1: t("4-posts-features-1"),features2: t("4-posts-features-2"),features3: t("4-posts-features-3"), postCitizenship: t("4-posts-citizenship"), startDate: "01.03.2023" , endDate: "20.03. 2024", additionalImages:  ["/4-1.jpg", "/4-2.jpg", "/4-3.jpg", "/4-4.jpg","/4-5.jpg", "/4-6.jpg", "/4-7.jpg", "/4-8.jpg","/4-9.jpg", "/4-10.jpg", "/4-11.jpg"] },
    { id: 5, title: t('5-posts-title'), description: t('5-posts-desc'), description2: t('5-posts-desc-2'), image: "/5-1.jpg", location: "Demirtaş", locationDesc: t('5-posts-loc-desc'), priceRange: t("5-posts-price"), features: t("5-posts-features") ,features1: t("5-posts-features-1"),features2: t("5-posts-features-2"),features3: t("5-posts-features-3"), postCitizenship: t("5-posts-citizenship"), startDate: "30.09.2023" , endDate: "30.11.2024", additionalImages:  ["5-1.jpg", "/5-2.jpg", "/5-3.jpg", "/5-4.jpg", "5-5.jpg", "/5-6.jpg", "/5-7.jpg", "/5-8.jpg","5-9.jpg", "/5-10.jpg", "/5-11.jpg", "/5-12.jpg","5-13.jpg", "/5-14.jpg", "/5-15.jpg"] },
    { id: 6, title: t('6-posts-title'), description: t('6-posts-desc'), description2: t('6-posts-desc-2'), image: "/6-1.jpg", location: "Kargicak", locationDesc: t('6-posts-loc-desc'), priceRange: t("1-posts-price"), features: t("6-posts-features") ,features1: t("6-posts-features-1"),features2: t("6-posts-features-2"),features3: t("6-posts-features-3"), postCitizenship: t("6-posts-citizenship"), startDate: "30.09.2023" , endDate: "30.03.2025", additionalImages:  ["/6-1.jpg", "/6-2.jpg", "/6-3.jpg", "/6-4.jpg", "/6-5.jpg", "/6-6.jpg", "/6-7.jpg", "/6-8.jpg", "/6-9.jpg", "/6-10.jpg", "/6-11.jpg", "/6-12.jpg", "/6-13.jpg", "/6-14.jpg", "/6-15.jpg", "/6-16.jpg", "/6-17.jpg", "/6-18.jpg", "/6-19.jpg", "/6-20.jpg", "/6-21.jpg", "/6-22.jpg" ] },
  ];
  const { id } = useParams();
  ...
  const imagesPerPageForMain: number = 1;
  ...
  const handlePreviousClickForMain = () => {
    if (currentIndex > 0) {
      setCurrentIndex(currentIndex - 1);
    }
  };

  const handleNextClickForMain = () => {
    if (currentIndex < imagesToDisplayForMain.length - 1) {
      setCurrentIndex(currentIndex + 1);
    }
  };
  ...
  const endIndexForMain: number = Math.min(currentIndex + imagesPerPageForMain, post.additionalImages.length);
  const imagesToDisplayForMain: string[] = post.additionalImages.slice(currentIndex, endIndexForMain);
